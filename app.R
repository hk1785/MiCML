    ...
    withProgress(
      ...
      detail = "This may take a while...", value = 0, {
        ...
        if(input$cf_method == "Double-sample tree") {
          ...
          set.seed(578, kind = "Mersenne-Twister", normal.kind = "Inversion")
          step1.result <- try(double.sample.treatment.pred(Feature, Response, Treatment, n.tree = 30000), silent = TRUE)
          ...
          for(name in level.names){
            ...
            set.seed(578, kind = "Mersenne-Twister", normal.kind = "Inversion")
            step3.result <- try(bort.func(step2.result, name, n.tree = 30000), silent = TRUE)
            ...
            set.seed(578, kind = "Mersenne-Twister", normal.kind = "Inversion")
            step4.result <- try(bort.treatment.pred(step2.result, name, n.tree = 30000), silent = TRUE)
        ...
        ## b. Propensity Tree ----------
          ...
          if(!is.null(input$cf_cov_options)){
            ...
            set.seed(578, kind = "Mersenne-Twister", normal.kind = "Inversion")
            step1.result <- try(propensity.treatment.pred(Feature, Response, Treatment, Covariate, n.tree = 30000), silent = TRUE)
          }
          ...
          # Step 1-2. Treatment Effect Prediction without Covariate
            ...
            set.seed(578, kind = "Mersenne-Twister", normal.kind = "Inversion")
            step1.result <- try(propensity.treatment.pred(Feature, Response, Treatment, n.tree = 30000), silent = TRUE)
          }
